...
//                Log.e("tag", "faces : " + faces.length + " , mode : " + mode );
    ...
    public static Camera2Demo newInstance() {
        return new Camera2Demo();
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                int maxPreviewWidth = mTextureView.getMeasuredWidth(); //displaySize.x;
                int maxPreviewHeight = mTextureView.getMeasuredHeight(); //displaySize.y;

                if (swappedDimensions) {
                    rotatedPreviewWidth = height;
                    rotatedPreviewHeight = width;
                    maxPreviewWidth = mTextureView.getMeasuredHeight();
                    maxPreviewHeight = mTextureView.getMeasuredWidth();
                }
